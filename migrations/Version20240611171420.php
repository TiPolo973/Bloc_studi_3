 ...
 */
final class Version20240611171420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP uuid, CHANGE user_id_id user_id_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE user_id_id user_id_id INT NOT NULL');
